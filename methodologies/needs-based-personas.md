...
**Start with JTBD, pains, and gains.** When these analyses are available from earlier research synthesis, they form the raw material for persona development. Each participant's set of jobs, pains, and gains represents their need profile. If JTBD and pains/gains work has not been done, persona creation begins with a lighter-weight needs extraction directly from transcript data, though this typically produces less robust results.

**Cluster by shared need patterns.** We look for participants who share similar combinations of jobs, pains, and gains. The clustering is qualitative and iterative -- it involves reading across participants, identifying recurring patterns, testing groupings, and refining until the clusters feel both internally coherent and mutually distinct. The goal is not statistical segmentation but meaningful distinction: each persona should represent a genuinely different orientation toward the service or experience being designed.

**Identify distinguishing characteristics.** Once clusters are formed, we examine what makes each group different from the others. This includes behavioral patterns (how they approach the service, what channels they prefer, how they make decisions), attitudes (their relationship to the domain, their level of trust, their expectations), and contextual factors (their life circumstances, prior experience, support systems). Demographics are noted where relevant but never treated as defining.

**Name the archetype.** Each persona receives a short, descriptive name that captures the essence of their orientation. These names should be neutral, memorable, and useful in conversation. We avoid names that stereotype or reduce people to a single trait. Good archetype names describe a stance or relationship: "The Cautious Navigator," "The Delegator," "The Self-Directed Researcher." The name should help a team member immediately recall what makes this persona distinct.

**Build the persona card.** The card is a structured summary designed for reference during design work. It should fit on a single page or screen and communicate the essentials at a glance.
...
- **Behavioral indicators:** Observable behaviors or patterns that help identify when a real person fits this persona. These are useful for service staff, for recruitment in future research, and for validating the persona's ongoing relevance.
...
**Acknowledge overlap.** Real people do not fit neatly into boxes. Some participants may sit between two personas or shift from one to another depending on circumstance. The persona set should acknowledge this rather than forcing artificial boundaries. Where overlap is significant, note it on the relevant cards.
