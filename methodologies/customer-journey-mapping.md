...
- **Thoughts:** What the person is thinking, drawn from transcript evidence rather than assumption. "I wonder if I need to bring documentation." "Why hasn't anyone contacted me?"
- **Emotional arc:** How the person feels across the journey, tracked as a continuous curve rather than isolated data points. The shape of this arc -- where it rises, where it drops, where it stays flat -- reveals the experiential structure of the service.
- **Pain points:** Specific moments of friction, confusion, frustration, or failure, mapped to the exact stage and touchpoint where they occur.
...
**Touchpoints per stage** are listed within each phase. A single stage may involve multiple touchpoints across different channels. The "Seeking advice" phase might include a website visit, a phone call, and a conversation with a friend. All are part of the experience.

**Actions** are expressed as verbs and describe what the person does. "Searches for symptoms online." "Calls the clinic." "Asks a colleague for a recommendation." Actions should be concrete and specific, not abstract.

**Thoughts** are drawn directly from transcript evidence and presented in the person's own language where possible. They capture the internal monologue -- the questions, assumptions, confusions, and calculations happening inside the person's head. "I'm not sure if this is serious enough to bother the doctor about." "I hope I don't have to explain this again."

**Emotions** are represented on a rated scale, typically ranging from highly negative to highly positive, with a neutral midpoint. The emotion is plotted for each stage, creating a continuous arc across the journey. The scale should be simple enough to read at a glance -- five points is usually sufficient. Emotional ratings are derived from participant language and tone, not from researcher assumption.

**Pain points** are called out explicitly at the stages where they occur. Each pain point includes a brief description and, where possible, a participant quote that illustrates it. Pain points from the pains and gains analysis can be mapped directly onto the journey.

**Moments of truth** are marked distinctly from ordinary touchpoints -- visually differentiated on the map. These are the interactions where the person's relationship with the service is most at stake. They deserve special design attention because improvements at these points have outsized impact on overall experience.

**Opportunities** are noted at specific points in the journey. Each opportunity should be grounded in the evidence -- it should be clear what pain it addresses or what gain it creates. Opportunities are not solutions; they are articulated spaces where design intervention would be most valuable.
