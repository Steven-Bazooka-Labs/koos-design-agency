...
| 2 | Next-tool promotions (per tool: harden, package, release); sector guardrail modules with practice leads; scale-out mechanism | scoped after the pilot decision |
