# koos-ai — the rollout, on one page

*Bazooka Labs · July 2026 · The detail (phases, costs, data handling, risks) is in the full plan next to this.*
...
- **Contracts:** every incoming contract goes through the Contract Checker, run by the people who actually handle contracts. Anything the tool drafts goes out only after your commercial owner signs off.
- **Design & research:** 2–3 designers use the Survey Builder and Token Generator where their projects need them.
...
2. **Steward names** — ideally two — and a 2-hour setup session.
3. The **contract-track owner, 2–3 designers**, and the pilot project(s).
4. **60–90 minutes with your research leads** to make the guardrails yours.
5. **Legal time** for the data checks, and a **#koos-ai** Slack channel.

## How we'll know it worked (judged by you, not by us)

≥3 live contracts through the tool, one reviewed amendment actually sent · time-per-review against a pre-pilot baseline, target set by you · ≥2 real design-tool runs used in project work · ≥2 improvements shipped from your team's feedback, at least one landing on every pilot machine mid-pilot · a clear verdict on the Google Drive workflow and update reliability · then the decision.
