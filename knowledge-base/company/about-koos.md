...
- **Amsterdam (HQ):** Danzigerbocht 39, 1013 AM Amsterdam, The Netherlands
- **Abu Dhabi:** Incubator Building, Masdar City, Abu Dhabi, United Arab Emirates
...
2. **UX/UI Design** — Designing digital products and interfaces grounded in user research. This spans discovery, concept development, prototyping, usability testing, and design system creation.
...
| Client | Result |
|---|---|
| Careem | Designed experiences for a super app serving 50 million users across the Middle East and North Africa |
| NS (Dutch Railways) | Improved services for 10.1 million daily passengers |
| CoronaCheck | Delivered the Dutch COVID certificate app: 16 million+ downloads, 250 million+ certificates issued |
| VGZ | Achieved a 13% increase in Net Promoter Score through service redesign |
| Rijkswaterstaat | Reduced permit processing time from 26 weeks to 8 weeks |
| Amsterdam Municipality | Helped reduce the teacher shortage from 18.7% to 12.2% through service design interventions |
